...
def file_fre(file,ii):
     #读入文件频率
    data=[]
    with open('/home/zjg/code3.31/fre/fre10years/'+file.replace('.tsv','')+'/fre0-Sam-pubmed_10_years_'+str(ii)+file,'r',encoding='utf-8')as fii:
        for lines in fii:
            json_data=lines
...
if __name__ == "__main__":
    ...
    #for i in range(0,1):
        ...
        #加完之后写入总的文件
        with open('/home/zjg/code3.31/fre/freall10years/'+'All-'+Filelist[i],'w',newline='')as fw:
